...
function connectConsultas(callback){
  ...
  //var url = "mongodb+srv://admin:admin@cluster0-ebu9m.mongodb.net/test?retryWrites=true&w=majority";


  var client = new MongoClient(process.env.DATABASE_URL,{useNewUrlParser:true});
